...
public class RoundAngleLRelativeLayout extends RelativeLayout {
	...
	public RoundAngleLRelativeLayout(Context context) {
		super(context);
		init(null, 0);
	}

	public RoundAngleLRelativeLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs, 0);
	}

	public RoundAngleLRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
	...
	private void init(AttributeSet attrs, int defStyle) {
		TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.RoundAngleFrameLayout);

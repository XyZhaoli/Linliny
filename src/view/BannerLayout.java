...
/**
 * 轮播图组件 Created by TwoSX on 2016/3/30.
 */
public class BannerLayout extends RelativeLayout {
	...
	private void init(AttributeSet attrs, int defStyleAttr) {
		...
		selectedIndecatorWidth = (int) array.getDimension(R.styleable.BannerLayoutStyle_selectedIndicatorWidth,
				selectedIndecatorWidth);
		...
		unSelectedIndecatorWidth = (int) array.getDimension(R.styleable.BannerLayoutStyle_unSelectedIndicatorWidth,
				unSelectedIndecatorWidth);
	...
	private void setSliderTransformDuration(int scrollDuration) {
		try {
			...
			FixedSpeedScroller fixedSpeedScroller = new FixedSpeedScroller(mViewPager.getContext(), null,
					scrollDuration);
	...
	private void switchIndicator(int currentPosition) {
		for (int i = 0; i < indicatorContainer.getChildCount(); i++) {
			((ImageView) indicatorContainer.getChildAt(i))
					.setImageDrawable(i == currentPosition ? selectedDrawable : unSelectedDrawable);
		}
	}
